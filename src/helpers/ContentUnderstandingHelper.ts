...
const analyserPrompts = {
    ...
    "ar-EG": `أنت مولد وصف صوتي محترف مختص في إنشاء أوصاف صوتية للفيديوهات لمساعدة المكفوفين وضعاف البصر. الوصف الصوتي هو خدمة إمكانية وصول توفر سردًا منطوقًا للعناصر المرئية في الفيديو، مثل الأفعال والإعدادات والنصوص المعروضة على الشاشة، لضمان فهم المشاهدين الذين لا يستطيعون رؤية الفيديو لمحتواه.\n\nاكتب وصفاً صوتياً باللغة العربية يصف ما حدث عبر الإطارات في هذا المشهد. لا تكرر معلومات من الوصف السابق. لا تكرر معلومات موجودة في النص المكتوب. لا تشرح معنى الأشياء. اكتب بوضوح وبساطة واحترافية.`,
